...
font_sizes_in_htmls :: [HTML] -> Set Int -> Set Int
font_sizes_in_htmls htmls sizes =
    foldr font_sizes_in_html sizes htmls
...
font_sizes_in_element (HTML_ul htmls) sizes = font_sizes_in_htmls htmls sizes
font_sizes_in_element (HTML_ol htmls) sizes = font_sizes_in_htmls htmls sizes
...
font_names_in_htmls :: [HTML] -> Set String -> Set String
font_names_in_htmls htmls names =
    foldr font_names_in_html names htmls
...
font_names_in_element (HTML_ul htmls) names = font_names_in_htmls htmls names
font_names_in_element (HTML_ol htmls) names = font_names_in_htmls htmls names
...
font_stuff_in_htmls :: (Font_tag -> a -> a) -> [HTML] -> a -> a
font_stuff_in_htmls f htmls stuff =
    foldr (font_stuff_in_html f) stuff htmls
...
font_stuff_in_element f (HTML_ul htmls) stuff =
    font_stuff_in_htmls f htmls stuff
font_stuff_in_element f (HTML_ol htmls) stuff =
    font_stuff_in_htmls f htmls stuff
